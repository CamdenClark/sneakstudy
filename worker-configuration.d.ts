/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: f50a000d1ec54bba008387d04e7a88eb)
// Runtime types generated with workerd@1.20260124.0 2025-08-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserDurableObject";
	}
	interface Env {
		WORKOS_API_KEY: string;
		WORKOS_CLIENT_ID: string;
		WORKOS_COOKIE_PASSWORD: string;
		USER_DO: DurableObjectNamespace<import("./src/index").UserDurableObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKOS_API_KEY" | "WORKOS_CLIENT_ID" | "WORKOS_COOKIE_PASSWORD">> {}
}
declare module "*.sql" {
	const value: string;
